import ImgRecomendados_a from "../../components/Admin/imgRecomendados/ImgRecomendados_a";
...
const ImgRecomendados = () => {
  ...
  useEffect(() => {
    ...
    const checkAuthStatus = async () => {
      try {
        const response = await fetch(`${config.api}check-session.php`, {
          method: "GET",
          mode: "cors",
          credentials: "include",
        });
...
export default ImgRecomendados;
